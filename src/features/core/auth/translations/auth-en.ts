...
export default {
    authTranslations: {
        ...
        emails: {
            ...
            invitation: {
                subject: "You're invited to join {branch}",
                text: "{inviter} invited you to join {branch}. Accept the invitation by visiting this link: {inviteUrl}.",
                html: {
                    intro: "You've been invited to join {branch}.",
        ...
        profile: {
            ...
            email: {
                ...
                addDescription:
                    "Add an email address to your account. A verification link will be sent to confirm it.",
                current: "Current email:",
                noCurrent: "No email is currently set on your account.",
                newLabel: "New email",
                addLabel: "Email",
            ...
            phone: {
                ...
                current: "Current phone: {phone}",
                noCurrent: "No phone number is currently set on your account.",
                ...
                verifyOtp: "Verify code",
                verifying: "Verifying...",
                verifyingFor: "Verifying",
                success: "Phone number updated successfully.",
                error: {
                    invalid: "Enter a valid phone number",
                    same: "Use a different phone number",
        ...
        emailVerification: {
            ...
            notice: {
                ...
                missingEmail: "Add an email address first to enable email verification.",
            },
            error: {
                missingOrigin: "Unable to determine application URL",
                sendFailed: "We couldn't send the verification email. Please try again.",
                missingEmail: "No email address is set on your account.",
        ...
        branch: {
            validation: {
                ...
                nameTooLong: "Branch name is too long",
            ...
            actions: {
                ...
                updateBranch: {
                    ...
                    ownerOnly: "Only the creator can edit the branch",
                    error: "Unable to update branch",
                },
                deleteBranch: {
                    notFound: "Branch not found",
                    ownerOnly: "Only the creator can delete the branch",
                    success: "Branch deleted",
                    confirmation:
                        "Delete {name}? This action cannot be undone and will remove the branch for all members.",
                },
                common: {
                    noOrgAccess: "You do not have access to that branch",
                },
                members: {
