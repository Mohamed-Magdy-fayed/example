  ...
  if (render && React.isValidElement(render)) {
    ...
    return (
      <SortableContentContext.Provider value={true}>
        ...
        >
          {React.cloneElement<any>(renderElement, {
            ...contentProps,
            className: cn(renderElement.props.className, contentProps.className),
            ref,
            children,
          })}
        </SortableContext>
...
function SortableItemHandle(props: SortableItemHandleProps) {
  const { asChild, disabled, className, render, ref, ...itemHandleProps } = props;
  ...
  if (render && React.isValidElement(render)) {
    ...
    return React.cloneElement<any>(renderElement, {
      ...
      disabled: isDisabled,
      ref: composedRef,
      children: renderElement.props.children ?? props.children,
    });
  }
