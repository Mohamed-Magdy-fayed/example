...
function Calendar({
  ...
  const { locale: translationLocale } = useTranslation();

  const locale = React.useMemo(() => {
    return translationLocale === "ar" ? arEG : enUS;
  }, [translationLocale]);
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_end: cn(
          "relative isolate -z-0 rounded-e-(--cell-radius) bg-muted after:absolute after:inset-y-0 after:start-0 after:w-4 after:bg-muted-200",
