  ...
  return (
    <Popover>
      ...
      >
        ...
        {columnFilterValue ? (
          <>
            ...
            <span className={cn(inPopover && "ms-auto truncate")}>
      ...
      <PopoverContent
        ...
        className={cn(
          "flex flex-col gap-4",
          inPopover ? "w-[min(22rem,88vw)]" : "w-auto",
        )}
      >
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              />
              {unit && (
                <span className="absolute inset-e-0 top-0 bottom-0 flex items-center rounded-e-md bg-accent px-2 text-muted-foreground text-sm">
                  {unit}
                </span>
              )}
            </div>
            <Label className="sr-only" htmlFor={`${id}-to`}>
              {t("dataTableTranslations.to")}
            </Label>
            <div className="relative">
              <Input
                aria-valuemax={max}
          ...
          <Label className="sr-only" htmlFor={`${id}-slider`}>
            {t("dataTableTranslations.slider", { title: title ?? column.id })}
          </Label>
          <Slider
            id={`${id}-slider`}
            max={max}
