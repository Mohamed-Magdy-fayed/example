        ...
        <section className="py-20">
            <div className="container mx-auto px-4 text-center">
                ...
                >
                    ...
                    <P className="text-muted-foreground mb-8">{t("skills.cta.description")}</P>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" asChild className="hover:scale-105 transition-transform duration-300">
                            <Link href="/contact">{t("skills.cta.primaryButton")}</Link>
                        </Button>
                        <Button
                            size="lg"
                            variant="outline"
                        ...
                        >
                            <Link href="/projects">{t("skills.cta.secondaryButton")}</Link>
                        </Button>
                    </div>
                </div>
            </div>
