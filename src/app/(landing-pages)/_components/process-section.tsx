    ...
    <section className="py-20 bg-muted/30" id="process">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <H2 className="text-primary mb-4">{t("process.header.title")}</H2>
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                ...
                <div className="bg-background rounded-xl p-6 shadow-sm border border-border/50 hover:shadow-lg transition-all duration-300 relative z-10">
                  {/* Step number */}
                  <div className="absolute -top-4 start-6 w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold">
                    {index + 1}
                  </div>
                  ...
                  {/* Content */}
                  <H3 className="text-lg mb-3 border-none pb-0">
                    {step.title}
                  </H3>
                  ...
                  <ul className="space-y-2">
                    {step.details.map((detail, detailIndex) => (
                      ...
                      >
                        <div className="w-1.5 h-1.5 bg-primary rounded-full me-2 flex-shrink-0" />
                        {detail}
                      </li>
                    ))}
                  </ul>
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div>
              <div className="text-2xl font-bold text-primary mb-2">
                {t("process.timeline.timeframes.discoveryDays")}
              </div>
              <P className="text-muted-foreground text-sm mt-0">
                {t("process.timeline.discoveryPlanning")}
              </P>
            </div>
            <div>
              <div className="text-2xl font-bold text-primary mb-2">
                {t("process.timeline.timeframes.designWeeks")}
              </div>
              <P className="text-muted-foreground text-sm mt-0">
                {t("process.timeline.designDevelopment")}
              </P>
            </div>
            <div>
              <div className="text-2xl font-bold text-primary mb-2">
                {t("process.timeline.timeframes.testingDays")}
              </div>
              <P className="text-muted-foreground text-sm mt-0">
                {t("process.timeline.testingLaunch")}
              </P>
            </div>
          </div>
