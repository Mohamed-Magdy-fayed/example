...
export function TestimonialsSection() {
  ...
  const testimonials = [
    {
      id: 1,
      name: t("testimonials.clients.arabianFoods.name"),
      company: t("testimonials.clients.arabianFoods.company"),
      role: t("testimonials.clients.arabianFoods.role"),
      content: t("testimonials.clients.arabianFoods.content"),
      rating: 5,
      image: "/api/placeholder/60/60",
    },
    {
      id: 2,
      name: t("testimonials.clients.ownedByAlaa.name"),
      company: t("testimonials.clients.ownedByAlaa.company"),
      role: t("testimonials.clients.ownedByAlaa.role"),
      content: t("testimonials.clients.ownedByAlaa.content"),
      rating: 5,
      image: "/api/placeholder/60/60",
    },
    {
      id: 3,
      name: t("testimonials.clients.emanTms.name"),
      company: t("testimonials.clients.emanTms.company"),
      role: t("testimonials.clients.emanTms.role"),
      content: t("testimonials.clients.emanTms.content"),
      rating: 5,
      image: "/api/placeholder/60/60",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial) => (
            ...
            >
              {/* Quote icon */}
              <div className="absolute -top-3 start-6 w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <H3 className="text-sm border-none pb-0 mb-1">
                    {testimonial.name}
                  </H3>
          ...
          <div className="flex justify-center items-center gap-8 opacity-60">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">
                {t("testimonials.trustIndicators.wordpressCertified")}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-muted rounded" />
              <span className="text-sm">
                {t("testimonials.trustIndicators.googlePartner")}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-muted rounded" />
              <span className="text-sm">
                {t("testimonials.trustIndicators.sslSecured")}
              </span>
            </div>
          </div>
        </div>
