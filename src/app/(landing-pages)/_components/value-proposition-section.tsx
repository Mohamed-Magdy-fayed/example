...
export function ValuePropositionSection() {
  ...
  const mainBenefits = [
    ...
    },
    {
      ...
      description: t(
        "valueProposition.mainBenefits.mobileResponsive.description",
      ),
    },
    {
      icon: User2,
    ...
    },
    {
      ...
      description: t(
        "valueProposition.mainBenefits.secureReliable.description",
      ),
    },
  ];
  ...
  const additionalBenefits = [
    {
      ...
      description: t(
        "valueProposition.additionalBenefits.quickTurnaround.description",
      ),
    },
    {
      icon: Headphones,
    ...
    },
    {
      ...
      description: t(
        "valueProposition.additionalBenefits.conversionFocused.description",
      ),
    },
    {
      icon: Award,
      ...
      description: t(
        "valueProposition.additionalBenefits.qualityGuaranteed.description",
      ),
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {additionalBenefits.map((benefit, index) => (
              <div key={index} className="text-center group">
                ...
                <H3 className="text-base mb-2 border-none pb-0">
                  {benefit.title}
                </H3>
                <P className="text-muted-foreground text-sm mt-0">
                  {benefit.description}
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          <div>
            ...
            <P className="text-muted-foreground text-sm mt-0">
              {t("valueProposition.stats.websitesDelivered")}
            </P>
          </div>
          <div>
            <div className="text-3xl font-bold text-primary mb-2">100%</div>
            <P className="text-muted-foreground text-sm mt-0">
              {t("valueProposition.stats.clientSatisfaction")}
            </P>
          </div>
          <div>
            <div className="text-3xl font-bold text-primary mb-2">4+</div>
            <P className="text-muted-foreground text-sm mt-0">
              {t("valueProposition.stats.yearsExperience")}
            </P>
          </div>
          <div>
            <div className="text-3xl font-bold text-primary mb-2">24/7</div>
            <P className="text-muted-foreground text-sm mt-0">
              {t("valueProposition.stats.supportAvailable")}
            </P>
          </div>
        </div>
      </div>
