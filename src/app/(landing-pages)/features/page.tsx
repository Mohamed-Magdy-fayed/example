        ...
        <div className="min-h-screen">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Button
                            ...
                            className="hover:scale-105 transition-transform duration-300"
                        >
                            <Link href="/projects">{t("features.hero.secondaryButton")}</Link>
                        </Button>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    ...
                    <div
                        className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 transition-all duration-1000 delay-300 ${featuresAnimation.isVisible
                            ? "opacity-100 translate-y-0"
                            : "opacity-0 translate-y-10"
                            }`}
                    >
                        {freeFeatures.map((feature, index) => (
                            <Card
                                ...
                                className="h-full hover:shadow-lg hover:-translate-y-2 transition-all duration-300 group border-green-200 dark:border-green-800"
                            >
                                <CardHeader>
            ...
            <section className="py-20 bg-gradient-to-bl from-stone-50 to-stone-100 dark:from-stone-900 dark:to-stone-950">
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {paidFeatures.map((feature, index) => (
                            <Card
                                key={`index-${index.toString()}`}
                                className="h-full hover:shadow-lg hover:-translate-y-2 transition-all duration-300 group border-orange-200 dark:border-orange-800"
                            >
                                <CardHeader>
                                    <div className="flex items-center justify-between mb-4">
            ...
            <section className="py-20">
                <div className="container mx-auto px-4">
                    <div
                        ...
                        className={`text-center mb-16 transition-all duration-1000 ${processAnimation.isVisible
                            ? "opacity-100 translate-y-0"
                            : "opacity-0 translate-y-10"
                            }`}
                    >
                    ...
                    <div
                        className={`grid md:grid-cols-2 lg:grid-cols-4 gap-8 transition-all duration-1000 delay-300 ${processAnimation.isVisible
                            ? "opacity-100 translate-y-0"
                            : "opacity-0 translate-y-10"
                            }`}
                    >
                        {process.map((step, index) => (
                            <div key={`index-${index.toString()}`} className="text-center group">
                                <div className="w-16 h-16 rounded-full bg-orange-100 dark:bg-orange-900/20 flex items-center justify-center mx-auto mb-6 group-hover:bg-orange-200 dark:group-hover:bg-orange-900/30 transition-colors duration-300">
                                    <span className="text-2xl font-bold text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300">
                                        {step.step}
                                    </span>
                                </div>
